...
class Type6(Enum):
    GreenEnergyMeasurement = 'GreenEnergyMeasurement'


class GreenEnergyMeasurement(BaseModel):
    ...
    biomassPowerGenerated: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    eolicPowerGenerated: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    geothermalPowerGenerated: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    hydroPowerGenerated: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    refGreenEnergyGenerator: Optional[
        Union[
            AnyUrl,
            Union[
                constr(
    ...
    solarPowerGenerated: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity Type. It has to be GreenEnergyMeasurement'
    )
